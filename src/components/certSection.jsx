          ...
          {certifications.map((cert, index) => (
            <div
              ...
              className={`
                ...
                ${visibleCerts.includes(index) ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}
              ...
              <div className="p-6 relative z-10">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1 pr-4">
                    ...
                    <p className="text-green-300 font-mono text-sm mb-1">{cert.issuer}</p>
                    <p className="text-green-300 font-mono text-xs">Issued: {cert.date}</p>
                  </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-green-400/10">
                  <span className="text-green-300 font-mono text-xs">ID: {cert.credentialId}</span>
